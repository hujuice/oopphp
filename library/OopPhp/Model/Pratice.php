...
class Pratice
{
    ...
    {
        $praticedir = \OopPhp\library\Config::getInstance()->paths['pratice'];
        $this->_page = parse_ini_file(APPLICATION_PATH . DIRECTORY_SEPARATOR . $praticedir . DIRECTORY_SEPARATOR . $name . '.ini');
    }
