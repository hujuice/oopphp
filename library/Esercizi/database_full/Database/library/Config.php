 ...
 * of the property is an associative array with the corresponding
 * key/value pairs.
...
class Config
{
     ...
     * @return \Database\library\Config The configuration instance, in the singleton way
     * @throw \Exception
     */
